...
public final class CreativeTabRefresher {
    ...
    public static void refreshRealm(Minecraft minecraft) {
        if (CreativeTabRegistry.REALM == null) {
            return;
        }

        refresh(minecraft, CreativeTabRegistry.REALM);
    }

    public static void refreshThief(Minecraft minecraft) {
        if (CreativeTabRegistry.THIEF == null) {
            return;
        }

        refresh(minecraft, CreativeTabRegistry.THIEF);
    }
