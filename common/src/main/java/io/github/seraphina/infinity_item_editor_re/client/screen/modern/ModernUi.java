...
public final class ModernUi {
    ...
    public static void fillToolboxBackdrop(GuiGraphicsExtractor guiGraphics, int width, int height) {
    ...
    public static void fillToolboxSidebar(GuiGraphicsExtractor guiGraphics, int x1, int y1, int x2, int y2) {
    ...
    public static void fillWorkSurface(GuiGraphicsExtractor guiGraphics, int x1, int y1, int x2, int y2) {
    ...
    public static void fillToolDrawer(GuiGraphicsExtractor guiGraphics, int x1, int y1, int x2, int y2, boolean selected) {
    ...
    public static void fillToolButton(GuiGraphicsExtractor guiGraphics, int x1, int y1, int x2, int y2,
    ...
    public static void fillToolInput(GuiGraphicsExtractor guiGraphics, int x1, int y1, int x2, int y2,
    ...
    public static void fillToolPaletteCell(GuiGraphicsExtractor guiGraphics, int x1, int y1, int x2, int y2,
    ...
    public static void fillRounded(GuiGraphicsExtractor guiGraphics, int x1, int y1, int x2, int y2, int radius, int color) {
        if (x2 <= x1 || y2 <= y1) {
            return;
        }
    ...
    public static void fillPanel(GuiGraphicsExtractor guiGraphics, int x1, int y1, int x2, int y2, int radius, int fill, int border) {
        if (x2 <= x1 || y2 <= y1) {
            return;
        }
    ...
    public static void fillGlassPanel(GuiGraphicsExtractor guiGraphics, int x1, int y1, int x2, int y2, int radius) {
        fillWorkSurface(guiGraphics, x1, y1, x2, y2);
        guiGraphics.fillGradient(x1 + 2, y1 + 15, x2 - 2, y2 - 2, alpha(0x62D1C7, 12), alpha(0x000000, 0));
    }

    public static void fillHeaderPanel(GuiGraphicsExtractor guiGraphics, int x1, int y1, int x2, int y2, int radius) {
    ...
    public static void fillContentGlow(GuiGraphicsExtractor guiGraphics, int x1, int y1, int x2, int y2) {
    ...
    public static void fillInset(GuiGraphicsExtractor guiGraphics, int x1, int y1, int x2, int y2, int radius, boolean focused, boolean active) {
        fillToolInput(guiGraphics, x1, y1, x2, y2, focused, active);
    }

    public static void fillPill(GuiGraphicsExtractor guiGraphics, int x1, int y1, int x2, int y2, int radius, int fill, int border) {
        fillPanel(guiGraphics, x1, y1, x2, y2, Math.min(radius, 5), fill, border);
    }

    public static void fillSlot(GuiGraphicsExtractor guiGraphics, int x, int y, boolean selected) {
    ...
    public static void fillSelection(GuiGraphicsExtractor guiGraphics, int x1, int y1, int x2, int y2, int radius, boolean emphasized) {
    ...
    public static void drawWindowControls(GuiGraphicsExtractor guiGraphics, int x, int y) {
    ...
    public static void fillItemWell(GuiGraphicsExtractor guiGraphics, int centerX, int centerY, int size) {
        int half = size / 2;
    ...
    public static void fillSoftHalo(GuiGraphicsExtractor guiGraphics, int centerX, int centerY, int width, int height, int color) {
    ...
    private static void drawRivets(GuiGraphicsExtractor guiGraphics, int leftX, int y, int rightX, int rightY) {
    ...
    private static void drawVentSlots(GuiGraphicsExtractor guiGraphics, int x1, int y1, int x2, int rows, int gap) {
        if (x2 <= x1) {
            return;
        }
