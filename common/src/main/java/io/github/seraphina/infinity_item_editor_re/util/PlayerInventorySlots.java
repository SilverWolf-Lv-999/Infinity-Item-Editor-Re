...
import io.github.seraphina.infinity_item_editor_re.mixin.SlotAccessor;
...
public final class PlayerInventorySlots {
    ...
    public static int toContainerSlot(Slot slot) {
        return slot == null ? -1 : toContainerSlot(((SlotAccessor) slot).infinityItemEditorRe$getContainerSlot());
    }
