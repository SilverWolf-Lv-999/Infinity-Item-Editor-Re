...
final class BundleItemScreen extends ContainerScreen {
    ...
    protected void slotClicked(Slot slot, int slotId, int mouseButton, ContainerInput clickType) {
        ...
        if (clickType == ContainerInput.SWAP && slot != null) {
    ...
    protected void extractLabels(GuiGraphicsExtractor guiGraphics, int mouseX, int mouseY) {
        ...
        guiGraphics.text(this.font, this.sourceInventory.getSourceName(), this.inventoryLabelX, this.inventoryLabelY, -12566464, false);
        Component page = Component.translatable(key("bundle.page"),
                this.bundleInventory.getPage() + 1, this.bundleInventory.getPageCount());
        guiGraphics.text(this.font, page, this.imageWidth + 4,
    ...
    private void handleSourceSlotClick(Slot slot, int mouseButton, ContainerInput clickType) {
    ...
    private void renderSourceScrollBar(GuiGraphicsExtractor guiGraphics) {
