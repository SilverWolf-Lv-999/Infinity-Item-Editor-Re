...
final class EditorGuiGraphics extends GuiGraphics {
    ...
    EditorGuiGraphics(Minecraft minecraft, GuiGraphics target, EditorViewport viewport, int mouseX, int mouseY) {
    ...
    @Override
    public void renderComponentHoverEffect(net.minecraft.client.gui.Font font, net.minecraft.network.chat.Style style, int mouseX, int mouseY) {
        super.renderComponentHoverEffect(font, style, (int) this.viewport.toLayout(mouseX), (int) this.viewport.toLayout(mouseY));
    }
}
