...
public final class SpecialComponentSelectionScreen extends CompatScreen {
    ...
    private void openEditor(ComponentEditorDefinition definition) {
        if (this.minecraft != null) {
            MinecraftCompat.setScreen(this.minecraft, new SpecialComponentEditorScreen(this.thisLastScreen, this, this.thisEditingStack, definition));
        }
    }

    private void returnToLastScreen() {
        if (this.minecraft != null) {
            MinecraftCompat.setScreen(this.minecraft, this.thisLastScreen);
        }
    }
