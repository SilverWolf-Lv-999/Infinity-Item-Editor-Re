...
public class ModernTextEditBox extends FilteredEditBox {
    ...
    private void renderVanillaTextInsideFrame(GuiGraphicsExtractor guiGraphics, int mouseX, int mouseY, float partialTick) {
        int originalX = getX();
        int originalY = getY();
